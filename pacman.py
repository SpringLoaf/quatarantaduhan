	...
	if not powerup:
		if (player_circle.colliderect(blinky.rect) and not blinky.dead) or \
			...
			if lives == 3:
				...
				pygame.draw.rect(screen, 'white', [50, 200, 800, 300],0, 10)
				pygame.draw.rect(screen, 'dark gray', [70, 220, 760, 260], 0, 10)
				q_1 = font.render(f'1. {list(game_q)[0]}', True, 'White')
				q_1_a = font.render(f'A. {list(game_q[list(game_q.keys())[0]].keys())[0]}', True, 'White')
				q_1_b = font.render(f'B. {list(game_q[list(game_q.keys())[0]].keys())[1]}', True, 'White')
				q_1_c = font.render(f'C. {list(game_q[list(game_q.keys())[0]].keys())[2]}', True, 'White')
				q_1_d = font.render(f'D. {list(game_q[list(game_q.keys())[0]].keys())[3]}', True, 'White')
				screen.blit(q_1, (100, 250))
				screen.blit(q_1_a, (100, 290))
				screen.blit(q_1_b, (100, 320))
				screen.blit(q_1_c, (100, 350))
				screen.blit(q_1_d, (100, 380))
				pygame.display.update()
				if whatis(answer_key_1) == False:
					game_over = True
					moving = False
					startup_counter = 0
			elif lives == 2:
				...
				pygame.draw.rect(screen, 'white', [50, 200, 800, 300],0, 10)
				pygame.draw.rect(screen, 'dark gray', [70, 220, 760, 260], 0, 10)
				q_1 = font.render(f'2. {list(game_q)[1]}', True, 'White')
				q_1_a = font.render(f'A. {list(game_q[list(game_q.keys())[1]].keys())[0]}', True, 'White')
				q_1_b = font.render(f'B. {list(game_q[list(game_q.keys())[1]].keys())[1]}', True, 'White')
				q_1_c = font.render(f'C. {list(game_q[list(game_q.keys())[1]].keys())[2]}', True, 'White')
				q_1_d = font.render(f'D. {list(game_q[list(game_q.keys())[1]].keys())[3]}', True, 'White')
				screen.blit(q_1, (100, 250))
				screen.blit(q_1_a, (100, 290))
				screen.blit(q_1_b, (100, 320))
				screen.blit(q_1_c, (100, 350))
				...
				pygame.draw.rect(screen, 'white', [50, 200, 800, 300],0, 10)
				pygame.draw.rect(screen, 'dark gray', [70, 220, 760, 260], 0, 10)
				q_1 = font.render(f'3. {list(game_q)[2]}', True, 'White')
				q_1_a = font.render(f'A. {list(game_q[list(game_q.keys())[2]].keys())[0]}', True, 'White')
				q_1_b = font.render(f'B. {list(game_q[list(game_q.keys())[2]].keys())[1]}', True, 'White')
				q_1_c = font.render(f'C. {list(game_q[list(game_q.keys())[2]].keys())[2]}', True, 'White')
				q_1_d = font.render(f'D. {list(game_q[list(game_q.keys())[2]].keys())[3]}', True, 'White')
				screen.blit(q_1, (100, 250))
				screen.blit(q_1_a, (100, 290))
				screen.blit(q_1_b, (100, 320))
				screen.blit(q_1_c, (100, 350))
